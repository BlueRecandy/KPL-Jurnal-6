...
{
    internal class GlossaryItem_1302204066
    {
		private string GetJsonPath => Path.GetFullPath(Directory.GetCurrentDirectory() + "/../../../jurnal6_3_1302204066.json");
		public void ReadJSON()
		{
			var file = File.OpenText(GetJsonPath);
			JsonElement json = JsonSerializer.Deserialize
				<JsonElement>(file.ReadToEnd());
